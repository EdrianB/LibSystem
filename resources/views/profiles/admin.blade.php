            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-muted text-center">Name: {{ $admin->name }}</p>
                        ...
                        <a href="#"
                           class="btn btn-primary btn-block"><b>Update Account</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                <div class="row">
                                    <div class="col-md-3 col-6"> <strong>First
                                            Name</strong>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <strong>Books Registered</strong>
                                        <p class="text-muted">Null</p>
                                    </div>
                                </div>
                                <hr>
