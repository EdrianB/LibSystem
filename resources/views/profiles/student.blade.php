                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                 src="{{asset($student->image)}}" style="width: 100px;height:100px;"
                                 alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center"></h3>

                        <p class="text-muted text-center">Name: {{ $student->fullname }}</p>

                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>ID</b> <a class="float-right">{{ $student->student_no }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Status</b> <a
                                    class="float-right">Active</a>
                            </li>
                            {{-- <li class="list-group-item">
                                <b>Supervision Requests</b> <a
                                    class="float-right">{{$supervisor->receivedSupervisions->count()}}</a>
                            </li> --}}
                        </ul>

                        <a href="#"
                           class="btn btn-primary btn-block"><b>Update Profile</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <strong>Other Names(Optional)</strong>
                                        <p class="text-muted">Null</p>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <strong>Title</strong>
                                        <p class="text-muted">Mrs/Mr</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <p class="text-muted">{{ $student->student_no }}</p>
                                    </div>
                                </div>
                                <hr>
                                {{-- <div class="row">
                          ...
                          10 Feb. 2014
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            <span class="time"><i
                                                    class="far fa-clock"></i> 12:05</span>
                                            ...
                                            <div class="timeline-body">
                                                ...
                                                imeem plugg dopplr jibjab,
                                                movity
                                                jajah plickers sifteo edmodo
                                                ifttt zimbra. Babblely odeo
                                                kaboodle
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            <span class="time"><i
                                                    class="far fa-clock"></i> 5 mins ago</span>
