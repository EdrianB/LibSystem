...
<body class="hold-transition sidebar-mini layout-fixed" data-panel-auto-height-mode="height">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#247464">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image" style="width:40px; height:40px; border-radius:50%">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('book.index') }}" class="nav-link" data-bs-toggle="modal" data-bs-target="#modal-report">
        ...
        <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
            ...
            <div class="tab-content">
                <div class="tab-empty">
                    <h2 class="display-4 text-center" style="color: black">MAKERERE UNIVERSITY BUSINESS SCHOOL e-LIBRARY SYSTEM</h2>
                </div>
