                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form method="post" action="{{ route('login Student') }}">
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            ...
                                            <a class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" href='{{ route('admin login page') }}'>Continue as Admin</a>
                                            
                                            <a class="text-muted" href="#">Forgot password?</a>
                                            <a class="text-muted" href="{{ route('student.create') }}">Create Account</a>
                                        </div>
